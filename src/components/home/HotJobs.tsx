...
const HotJobs = () => {
  const jobsData = [
    ...
    },
    {
      ...
      companyName: 'CÔNG TY TNHH OpsTech',
      salary: '80 triệu - 10 triệu',
      city: 'Hồ Chí Minh',
    },
    {
      ...
      companyName: 'CÔNG TY TNHH SalesForce',
      salary: '60 triệu - 80 triệu',
      city: 'Đà Nẵng',
    },
    {
      ...
      companyName: 'CÔNG TY TNHH SupportHub',
      salary: '40 triệu - 60 triệu',
      city: 'Hà Nội',
    },
    {
      ...
      companyLogo: 'https://2momart.vn/upload/medium/042020/sendo-app-01.png',
      jobTitle: 'IT Manager',
      companyName: 'CÔNG TY TNHH ITLeaders',
      salary: '90 triệu - 11 triệu',
      city: 'Hồ Chí Minh',
    },
    {
      ...
      companyName: 'CÔNG TY TNHH FinancePlus',
      salary: '70 triệu - 90 triệu',
      city: 'Đà Nẵng',
    },
  ];
